...
function Navbar({ currentPage, onPageChange, onLogout }: NavbarProps) {
  return (
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex gap-2 items-center">
            ...
            {onLogout && (
              <button
                onClick={onLogout}
                className="ml-4 bg-red-700 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-all"
              >
                Logout
              </button>
            )}
